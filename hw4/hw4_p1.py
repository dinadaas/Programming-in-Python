...
def naive_bayes(class_probabilities,feature_probabilities,instance):
    ...
    class_probs_naive = dict()
    for i in class_probabilities:
    	class_probs_naive[i] = class_probabilities[i]
    for x in instance
    	current = instance[x]
    	for y in class_probs_naive:
    		feat = feature_probabilities[x][y][current]
    		class_probs_naive[y] = class_probs_naive[y] * feat
    class_probs_naive = normalize(class_probs_naive)
    return class_probs_naive
